...
class EMongoAuthManager extends CAuthManager
{
    /**
    ...
    public function checkAccess($itemName, $userId, $params = array())
    {
        ...
        Yii::trace('Checking permission "' . $item->getName() . '"', 'application.extensions.MongoYii.EMongoAuthManager');
    ...
    public function load()
    {
        ...
        $items = $this->loadFromCollection();

        if (!isset($items['_id']))
            $items['_id'] = new MongoId();
     ...
     * @see saveToFile
     */
    protected function loadFromCollection()
    {
        $data = $this->db->selectCollection($this->collection)->findOne();
     ...
     * @see loadFromFile
     */
    protected function saveToCollection(array $data)
    {
        $this->db->selectCollection($this->collection)->save($data);
    }
