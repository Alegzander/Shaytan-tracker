...
//Constants
	...
	public function init()
	{
		...
		$this->setImport(array(
			...
			'srbac.components.SrbacUtils',
			'srbac.components.EAuthItem',
			'srbac.components.SrbacWraperController',
		...
		$this->notAuthorizedView = 'webroot.themes.' . Yii::app()->theme->name . '.views.srbac.authitem.unauthorized';
		//Publish css
