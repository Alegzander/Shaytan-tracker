...
//  }
	...
	public function rules()
	{
		return array(
			...
			array('type', 'in', 'range' => array_flip(self::$TYPES), 'allowEmpty' => true),
	...
	public function search()
	{
		...
		$criteria->alias = 'AuthItem';

		$criteria->compare($criteria->alias . '.name', $this->name, true);
		$criteria->compare($criteria->alias . '.type', $this->type);
