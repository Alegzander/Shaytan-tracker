...
if ($action=="groups" && $do=="view"){
	...
	print("<tr>\n");
	print("<th class='table_head'>Name</th>\n");
	print("<th class='table_head'>Torrents<br />".T_("GROUPS_VIEW_EDIT_DEL")."</th>\n");
	print("<th class='table_head'>Members<br />".T_("GROUPS_VIEW_EDIT_DEL")."</th>\n");
	print("<th class='table_head'>News<br />".T_("GROUPS_VIEW_EDIT_DEL")."</th>\n");
	print("<th class='table_head'>Forum<br />".T_("GROUPS_VIEW_EDIT_DEL")."</th>\n");
	print("<th class='table_head'>Upload</th>\n");
	print("<th class='table_head'>Download</th>\n");
	print("<th class='table_head'>View CP</th>\n");
    print("<th class='table_head'>Staff Page</th>");
    print("<th class='table_head'>Staff Public</th>");
    print("<th class='table_head'>Staff Sort</th>");
	print("<th class='table_head'>Delete</th>\n");
	print("</tr>\n");
...
if ($action == "users")
{
    ...
    begin_frame("Simple User Search");
    ?>
