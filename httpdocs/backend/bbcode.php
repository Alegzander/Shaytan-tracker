...
//
//  TorrentTrader v2.x
//      $LastChangedDate: 2011-11-15 17:58:11 +0000 (Tue, 15 Nov 2011) $
...
<br />
<table class='f-border' width='600px' border='0' align='center' cellpadding='6' cellspacing='0'>
  <tr class='f-title'>
  ...
  <tr>
    <td class='bb-comment f-border' align='center' valign='top'><textarea name="<?php echo $name; ?>" rows="10" cols="50"><?php echo $content; ?></textarea></td>
    <td class='bb-btn f-border' width='130' align="center" valign='top'>
      ...
      <a href="javascript:PopMoreTags();"><?php echo "[".T_("MORE_TAGS")."]";?></a><br />
    </td>
  </tr>
</table>
<br />
