...
//
//  TorrentTrader v2.x
//	$LastChangedDate: 2011-11-11 01:47:12 +0000 (Fri, 11 Nov 2011) $
...
function validusername($username) {
  ...
  if ($message == "") {
   ...
   $ret = SQL_Query_exec("INSERT INTO users (username, password, secret, email, status, added, age, country, gender, client, stylesheet, language, class, ip) VALUES (" .
...
<form method="post" action="account-signup.php?takesignup=1">
	...
	<table cellspacing="0" cellpadding="2" border="0">
			<tr>
				<td><?php echo T_("USERNAME"); ?>: <font class="small" color="#ff0000">*</font></td>
				<td><input type="text" size="40" name="wantusername" /></td>
			</tr>
			<tr>
				<td><?php echo T_("PASSWORD"); ?>: <font class="small" color="#ff0000">*</font></td>
				<td><input type="password" size="40" name="wantpassword" /></td>
			</tr>
			<tr>
				<td><?php echo T_("CONFIRM"); ?>: <font class="small" color="#ff0000">*</font></td>
				<td><input type="password" size="40" name="passagain" /></td>
			</tr>
			<?php if (!$invite_row) {?>
			<tr>
				<td><?php echo T_("EMAIL"); ?>: <font class="small" color="#ff0000">*</font></td>
